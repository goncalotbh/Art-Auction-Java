...
class BSTNode<K,V> implements Serializable  {
     ...
     *   
     * @param newEntry the new entry to be assigned
     */
    ...
    /**
     * Assigns a new key and value to the current BST node
     * 
     * @param newKey the new key to be assigned to the entry
     * @param newValue the new value to be assigned to the entry
     */
     ...
     * 
     * @param newKey the new key of the current node
     */
     ...
     * 
     * @param newValue the new value of the current node
     */
